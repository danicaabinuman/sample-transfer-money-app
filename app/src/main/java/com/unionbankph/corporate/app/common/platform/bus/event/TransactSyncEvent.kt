...
class TransactSyncEvent : BaseEventBus<Account>() {
    ...
    companion object {
        ...
        const val ACTION_GO_TO_PAYMENT_LINK_LIST_DASHBOARD = "go_to_payment_link_list_dashboard"
        const val ACTION_VALIDATE_MERCHANT_EXIST_DASHBOARD = "validate_merchant_exist_dashboard"
    }
}
