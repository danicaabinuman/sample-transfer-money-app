...
class OffSetCirclePagerIndicatorDecoration : RecyclerView.ItemDecoration() {
...
//        val indicatorStartX = (parent.width - indicatorTotalWidth) / 2f // Use this to center the dots
        val indicatorStartX = (parent.width - indicatorTotalWidth) / 1.05f
