...
import com.unionbankph.corporate.feature.loan.AddressInformationField.Companion.PERMANENT_ADDRESS_REGION
...
import com.unionbankph.corporate.feature.loan.AddressInformationField.Companion.PRESENT_ADDRESS_REGION
                    ...
                    state.apply {
                        when (form.formField) {
                            ...
                            PRESENT_ADDRESS_REGION -> {
                                presentAddressRegionError = if (form.presentAddressRegion.isNullOrBlank()) {
                                    context.getString(R.string.error_invalid_input)
                                } else {
                                    null
                                }
                            ...
                            PERMANENT_ADDRESS_REGION -> {
                                permanentAddressRegionError = if (form.permanentAddressRegion.isNullOrBlank()) {
                                    context.getString(R.string.error_invalid_input)
                                } else {
                                    null
                                }
    ...
    fun setSameAddress() {
       ...
       if (form.value != null) {
           if (sameAddress.value == true) {
               ...
               it.permanentAddressRegion = it.presentAddressRegion
                ...
                _form.updateFields {
                    ...
                    it.value?.let { form ->
                        when (data.second) {
                            ...
                            PRESENT_ADDRESS_REGION -> form.presentAddressRegion = data.first
