...
class PesoNetFormActivity :
    BaseActivity<ActivityFundTransferFormPesonetBinding, PesoNetViewModel>(),
            ...
            listItems(
                ...
                selection = { _, index, text ->
                    ...
                    if (purpose?.description.equals("Others", true)) {
                        this@PesoNetFormActivity.binding.viewPurpose.textInputLayoutLeavePurpose.visibility =
                            View.VISIBLE
                        this@PesoNetFormActivity.binding.viewPurpose.textInputEditTextLeavePurpose.text?.clear()
                    } else {
                        this@PesoNetFormActivity.binding.viewPurpose.textInputLayoutLeavePurpose.visibility = View.GONE
                        this@PesoNetFormActivity.binding.viewPurpose.textInputEditTextLeavePurpose.setText("-")
                    }
                    this@PesoNetFormActivity.binding.viewPurpose.textInputEditTextPurpose.setText(text.toString())
                }
            )
        }
    }
    ...
    private fun initEditTextDefaultValue() {
        ...
        if (binding.viewReceivingBankForm.textInputEditTextReceivingBank.length() != 0) {
            binding.viewReceivingBankForm.textInputEditTextReceivingBank.setText(binding.viewReceivingBankForm.
