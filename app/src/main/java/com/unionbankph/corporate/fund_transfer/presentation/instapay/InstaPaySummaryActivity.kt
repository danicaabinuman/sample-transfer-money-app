...
import com.unionbankph.corporate.databinding.ActivityFundTransferSummaryInstapayBinding
...
class InstaPaySummaryActivity :
    BaseActivity<ActivityFundTransferSummaryInstapayBinding, InstaPayViewModel>(),
    OnTutorialListener {
    ...
    private lateinit var fundTransferInstaPayForm: FundTransferInstaPayForm
    ...
    private fun initTutorialViewModel() {
        ...
        // tutorialViewModel.hasTutorial(TutorialScreenEnum.INSTAPAY_SUMMARY)
    }
    ...
    private fun setupBinding() {
        viewModel.contextualClassFeatureToggle.subscribe {
            if (intent.getStringExtra(EXTRA_FUND_TRANSFER) != null &&
                ...
                setFundTransferDetails(fundTransferInstaPayForm, selectedAccount, it)
            }
        }.addTo(disposables)
    }
        ...
        if (isSkipTutorial) {
            ...
            when (view) {
                binding.buttonViewOrganizationTransactions -> {
                    ...
                    binding.scrollView.post { binding.scrollView.smoothScrollTo(0, 0) }
                    // tutorialViewModel.setTutorial(TutorialScreenEnum.INSTAPAY_SUMMARY, false)
                }
            }
        }
    }
    ...
    private fun setFundTransferDetails(
        ...
        if (fundTransferInstaPayForm.remarks == null || fundTransferInstaPayForm.remarks == "") {
            ...
            .subscribe { granted ->
                if (granted) {
                    ...
                    MaterialDialog(this).show {
                        lifecycleOwner(this@InstaPaySummaryActivity)
    ...
    private fun showShareableContent() {
        RxQrCode.generateQrCodeFile(
            ...
            .doOnSubscribe { showProgressAlertDialog(InstaPaySummaryActivity::class.java.simpleName) }
            .subscribe(
                {
    ...
    override val bindingInflater: (LayoutInflater) -> ActivityFundTransferSummaryInstapayBinding
        get() = ActivityFundTransferSummaryInstapayBinding::inflate
}
