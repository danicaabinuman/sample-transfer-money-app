...
import kotlinx.android.synthetic.main.activity_fund_transfer_summary_instapay.*
...
class InstaPaySummaryActivity :
    BaseActivity<InstaPayViewModel>(R.layout.activity_fund_transfer_summary_instapay),
    OnTutorialListener {
