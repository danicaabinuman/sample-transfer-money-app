...
class SwiftSummaryActivity :
    ...
    private lateinit var fundTransferSwiftForm: FundTransferSwiftForm
    ...
    private fun initTutorialViewModel() {
        ...
        // tutorialViewModel.hasTutorial(TutorialScreenEnum.SWIFT_SUMMARY)
    }
    ...
    private fun setupBinding() {
        viewModel.contextualClassFeatureToggle.subscribe {
            if (intent.getStringExtra(EXTRA_FUND_TRANSFER) != null &&
                ...
                setFundTransferDetails(fundTransferSwiftForm, selectedAccount, it)
            }
        }.addTo(disposables)
    }
            ...
            .subscribe { granted ->
                if (granted) {
                    ...
                    MaterialDialog(this).show {
                        lifecycleOwner(this@SwiftSummaryActivity)
