...
class PDDTSConfirmationActivity :
    ...
    override fun onInitializeListener() {
        ...
        RxView.clicks(buttonSubmit)
            ...
            .subscribe {
                viewModel.fundTransferPDDTS(fundTransferPesoNetForm!!)
            }
            .addTo(disposables)
    }
    ...
    private fun initTutorialViewModel() {
        ...
        // tutorialViewModel.hasTutorial(TutorialScreenEnum.PDDTS_CONFIRMATION)
    }
    ...
    private fun initViewModel() {
        ...
        viewModel.state.observe(this, Observer {
            ...
            when (it) {
                is ShowPDDTSLoading -> {
                    showProgressAlertDialog(PDDTSConfirmationActivity::class.java.simpleName)
                }
    ...
    private fun showMultiplePostingDialog() {
        MaterialDialog(this).show {
            lifecycleOwner(this@PDDTSConfirmationActivity)
    ...
    private fun navigatePDDTSSummaryScreen(it: ShowPDDTSSkipOTPSuccess) {
        val bundle = Bundle()
        bundle.putString(
        ...
        bundle.putString(
            PDDTSSummaryActivity.EXTRA_ACCOUNT,
            JsonHelper.toJson(selectedAccount)
        )
        bundle.putString(
            PDDTSSummaryActivity.EXTRA_ACCOUNT_TYPE,
    ...
    private fun navigateVerifyAccountScreen(it: ShowPDDTSSuccess) {
        val bundle = Bundle()
        bundle.putString(
        ...
        bundle.putString(
            ...
            OTPActivity.PAGE_FUND_TRANSFER_PDDTS
        )
        bundle.putString(
