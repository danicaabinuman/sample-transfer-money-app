...
class FeesAndChargesFragment :
    BaseFragment<FragmentFeesAndChargesBinding, FeesAndChargesViewModel>() {
    ...
    override val viewModelClassType: Class<FeesAndChargesViewModel>
        get() = FeesAndChargesViewModel::class.java
}