...
class BusinessPolicyCameraActivity :
    ...
    override fun onBackPressed() {
        ...
        val bundle = Bundle().apply {
            putParcelableArrayList(
                ...
                intent.getParcelableArrayListExtra<Uri>(BusinessInformation2ndScreenActivity.LIST_OF_IMAGES_URI)
            )
        }
        navigator.navigate(
            this,
    ...
    private fun initCameraView() {
        ...
        with(binding.cameraView) {
            setLifecycleOwner(this@BusinessPolicyCameraActivity)
    ...
    private fun navigateImageScreen(filePath: String?) {
        val bundle = Bundle().apply {
            putString(
                BusinessPolicyImagePreviewActivity.EXTRA_FILE_PATH,
                filePath
            )
            putParcelableArrayList(
                BusinessInformation2ndScreenActivity.LIST_OF_IMAGES_URI,
        ...
        navigator.navigate(
            this,
            BusinessPolicyImagePreviewActivity::class.java,
            bundle,
            isClear = true,
            isAnimated = true,
