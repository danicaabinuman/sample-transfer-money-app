...
class DocumentImagePreviewActivity :
    BaseActivity<DocumentCameraViewModel>(R.layout.activity_onboarding_image_preview) {
    ...
    private fun init() {
        ...
        uriArrayList = intent.getParcelableArrayListExtra<Uri>(CardAcceptanceUploadDocumentsActivity.LIST_OF_IMAGES_URI).notNullable() as ArrayList<Uri>
    }
